...
public class Programme
{
    ...
    [XmlElement(ElementName = "title")] public List<Title>? Title { get; set; }

    [XmlElement(ElementName = "desc")] public List<Desc>? Desc { get; set; }

    [XmlElement(ElementName = "date")] public string? Date { get; set; }

    [XmlElement(ElementName = "category")] public List<Category>? Category { get; set; }

    [XmlElement(ElementName = "episode-num")]
    public List<EpisodeNum>? EpisodeNum { get; set; }

    [XmlElement(ElementName = "audio")] public Audio? Audio { get; set; }
    ...
    [XmlAttribute(AttributeName = "stop")] public string? Stop { get; set; }
